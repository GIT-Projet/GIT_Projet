...
require_once '../backend/mail.php';  //  chemin pour mail.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $activation_token = bin2hex(random_bytes(16));  // Token unique
    ...
    if ($stmt->execute()) {
        ...
        // Redirection vers home.php ou une page de confirmation
